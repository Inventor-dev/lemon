package xyz.lemone.lemon.system.authorization.client;
...
import xyz.lemone.lemon.system.authorization.settings.ClientSettings;
import xyz.lemone.lemon.system.authorization.settings.TokenSettings;
...
public class RegisteredClient implements Serializable {
    ...
    /**
     * Returns the post logout redirect URI(s) that the client may use for logout. The {@code post_logout_redirect_uri}
     * parameter is used by the client when requesting that the End-User's User Agent be redirected to after a logout
     * has been performed.
     *
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(this.id, that.id) && Objects.equals(this.clientId, that.clientId) && Objects.equals(
                this.clientIdIssuedAt, that.clientIdIssuedAt) && Objects.equals(this.clientSecret, that.clientSecret)
                && Objects.equals(this.clientSecretExpiresAt, that.clientSecretExpiresAt) && Objects.equals(
                this.clientName, that.clientName) && Objects.equals(this.clientAuthenticationMethods,
                that.clientAuthenticationMethods) && Objects.equals(this.authorizationGrantTypes,
                that.authorizationGrantTypes) && Objects.equals(this.redirectUris, that.redirectUris) && Objects.equals(
                this.postLogoutRedirectUris, that.postLogoutRedirectUris) && Objects.equals(this.scopes, that.scopes)
                && Objects.equals(this.clientSettings, that.clientSettings) && Objects.equals(this.tokenSettings,
                that.tokenSettings);
    }
    ...
    public static class Builder implements Serializable {
         ...
         *
         * @param clientSecretExpiresAt the time at which the client secret expires or {@code null} if it does not
         *                              expire
         * @return the {@link Builder}
         */
        ...
        /**
         * Adds a post logout redirect URI the client may use for logout. The {@code post_logout_redirect_uri} parameter
         * is used by the client when requesting that the End-User's User Agent be redirected to after a logout has been
         * performed.
         *
        ...
        private boolean isPublicClientType() {
            return this.authorizationGrantTypes.contains(AuthorizationGrantType.AUTHORIZATION_CODE)
                    && this.clientAuthenticationMethods.size() == 1 && this.clientAuthenticationMethods.contains(
        ...
        private static boolean validateScope(String scope) {
            return scope == null || scope.chars().allMatch(
                    c -> withinTheRangeOf(c, 0x21, 0x21) || withinTheRangeOf(c, 0x23, 0x5B) || withinTheRangeOf(c, 0x5D,
                            0x7E));
        }
