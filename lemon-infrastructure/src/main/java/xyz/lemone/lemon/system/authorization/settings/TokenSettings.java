...
public final class TokenSettings extends AbstractSettings {
    ...
    /**
     * Returns the token format for an access token. The default is {@link OAuth2TokenFormat#SELF_CONTAINED}.
     *
    ...
    /**
     * Returns {@code true} if refresh tokens are reused when returning the access token response, or {@code false} if a
     * new refresh token is issued. The default is {@code true}.
     */
    ...
    /**
     * Returns the {@link SignatureAlgorithm JWS} algorithm for signing the {@link OidcIdToken ID Token}. The default is
    ...
    public static Builder builder() {
        return new Builder().authorizationCodeTimeToLive(Duration.ofMinutes(5))
                .accessTokenTimeToLive(Duration.ofMinutes(5)).accessTokenFormat(OAuth2TokenFormat.SELF_CONTAINED)
                .deviceCodeTimeToLive(Duration.ofMinutes(5)).reuseRefreshTokens(true)
                .refreshTokenTimeToLive(Duration.ofMinutes(60)).idTokenSignatureAlgorithm(SignatureAlgorithm.RS256);
    }
    ...
    public static final class Builder extends AbstractBuilder<TokenSettings, Builder> {
        ...
        /**
         * Set the time-to-live for an authorization code. Must be greater than {@code Duration.ZERO}. A maximum
         ...
         *
         * @param idTokenSignatureAlgorithm the {@link SignatureAlgorithm JWS} algorithm for signing the
