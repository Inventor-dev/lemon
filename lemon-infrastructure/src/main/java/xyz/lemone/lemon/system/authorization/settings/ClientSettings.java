...
public final class ClientSettings extends AbstractSettings {
    ...
    /**
     * Returns {@code true} if the client is required to provide a proof key challenge and verifier when performing the
     * Authorization Code Grant flow. The default is {@code false}.
     *
     * @return {@code true} if the client is required to provide a proof key challenge and verifier, {@code false}
     * otherwise
     */
    ...
    /**
     * Returns {@code true} if authorization consent is required when the client requests access. The default is
     * {@code false}.
     *
     * @return {@code true} if authorization consent is required when the client requests access, {@code false}
     * otherwise
     */
    ...
    /**
     * Returns the {@link JwsAlgorithm JWS} algorithm that must be used for signing the {@link Jwt JWT} used to
     ...
     *
     * @return the {@link JwsAlgorithm JWS} algorithm that must be used for signing the {@link Jwt JWT} used to
    ...
    public static final class Builder extends AbstractBuilder<ClientSettings, Builder> {
         ...
         *
         * @param requireProofKey {@code true} if the client is required to provide a proof key challenge and verifier,
         ...
         *
         * @param requireAuthorizationConsent {@code true} if authorization consent is required when the client requests
        ...
        /**
         * Sets the {@link JwsAlgorithm JWS} algorithm that must be used for signing the {@link Jwt JWT} used to
         * authenticate the Client at the Token Endpoint for the
         * {@link ClientAuthenticationMethod#PRIVATE_KEY_JWT private_key_jwt} and
         * {@link ClientAuthenticationMethod#CLIENT_SECRET_JWT client_secret_jwt} authentication methods.
         *
         * @param authenticationSigningAlgorithm the {@link JwsAlgorithm JWS} algorithm that must be used for signing
         *                                       the {@link Jwt JWT} used to authenticate the Client at the Token
         *                                       Endpoint
         * @return the {@link Builder} for further configuration
         * @since 0.2.2
         */
